...
- **J001-O001** - Slip Detection Lag: Minimize the time between an item
  starting to slip and the bird-dogger noticing.
- **J001-O002** - Coverage: Minimize the likelihood that an open item is
  forgotten between checkpoints.
- **J001-O003** - Status Fidelity: Maximize the confidence that each item's
  tracked status reflects its true status.
- **J001-O004** - Triage Speed: Minimize the time to identify which items
